        ...
        <table class="form-table">
			...
			<tr valign="top">
				...
				<td><label for="upload_image">
					...
					<p class="description"><?php _e( 'Enter a URL or upload logo image. Maximum height: 70px, width: 310px.', 'customize-login-image' ); ?></p>
